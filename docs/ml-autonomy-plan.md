...
- **Текущее доказанное состояние:** Фаза 0 открыта. Чистый `1b11a54` на M4 Pro
  прошёл 2 441 backend-тест, аттестацию шести окружений, пять продуктовых профилей,
  десять прямых verifier cases и принудительный rollback. Полный smoke завершил
