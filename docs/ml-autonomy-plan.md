...
Следующая предлагаемая ограниченная цель — read-only аудит данных и provenance
из Фазы 1. Только после отдельного разрешения владельца следует проверить
права и согласие, происхождение, состав, annotation schema, дубли и
source/game/replay groups выбранных источников и записать coverage/blocker report.
